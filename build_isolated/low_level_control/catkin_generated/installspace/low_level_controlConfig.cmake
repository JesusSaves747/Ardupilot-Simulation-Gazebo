...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'low_level_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/savio/Documents/cmsvt_mbzirc/install_isolated/${idir}'.  Ask the maintainer 'savio <savio@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/savio/Documents/cmsvt_mbzirc/install_isolated/lib;/home/savio/Documents/cmsvt_mbzirc/devel/lib;/opt/ros/kinetic/lib)
